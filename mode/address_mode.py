...
class Address_mode:
    ...
    def address_mode(self,Parameters):
        ...
        if '"firstname":' in data:
            data = Parameters_cls().firstname(casename, data, spec_case['spec_firstname'])
        if '"lastname":' in data:
            data = Parameters_cls().lastname(casename, data, spec_case['spec_lastname'])
        if '"contactnumber":' in data:
            data = Parameters_cls().contactnumber(casename, data, spec_case['spec_contactnumber'])
        if '"id":' in data:
